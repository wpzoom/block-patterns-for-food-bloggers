...
return array(
    'title'      => __( 'Hero #1', 'wpzoom' ),
    'categories' => array( 'wpz-featured' ),
    'content'    => '<!-- wp:group {"align":"full","style":{"color":{"gradient":"linear-gradient(180deg,rgb(250,250,250) 41%,rgb(255,255,255) 100%)"}},"className":"wpz_pattern_3"} -->
<div class="wp-block-group alignfull wpz_pattern_3 has-background" style="background:linear-gradient(180deg,rgb(250,250,250) 41%,rgb(255,255,255) 100%)"><!-- wp:spacer {"height":"50px","className":"eplus-wrapper"} -->
<div style="height:50px" aria-hidden="true" class="wp-block-spacer eplus-wrapper"></div>
<!-- /wp:spacer -->

<!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"48px","fontStyle":"normal","fontWeight":"600"}}} -->
<h2 class="has-text-align-center" style="font-size:48px;font-style:normal;font-weight:600">Easy fresh recipes for everyday life</h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><strong>Chicken</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>Pasta</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>Vegetables</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>Fish</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>Browse all</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
